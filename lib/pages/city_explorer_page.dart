...
import 'package:page_view_app/model/Detail.dart';
...
class _CityExplorerPageState extends State<CityExplorerPage> {
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                _detailsTextBuilder(currentPage),
  ...
  Widget _detailsTextBuilder(index) {
        ...
        child: Transform.translate(
          ...
          child: Opacity(
            ...
            padding: EdgeInsets.only(left: 20.0, right: 20.0),
              child: Column(
               children: <Widget>[
                 Text(detailsList[index].title, style: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w600),),
                 SizedBox(height: 20.0),
                 Text(detailsList[index].description, style: TextStyle(fontSize: 18.0),),
